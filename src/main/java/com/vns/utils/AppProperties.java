...
public class AppProperties extends Properties
{
	...
	// Created Date : 16/09/2004
	// //////////////////////////////////////////////////////
	public void init(String[] properties, String value, boolean isOveride)
			throws AppException
	{
	...
	// Created Date : 16/09/2004
	// //////////////////////////////////////////////////////
	public AppProperties copy(String prefix, boolean isRemovePrefix)
			throws AppException
	{
	...
	public int getInt(String key) throws AppException
	{
		...
		try
		{
			...
			{
				return Integer.parseInt(strValue.substring(0,
						strValue.length() - 2));
			}
			else
			{
		...
		{
			throw new AppException(key + " is not an integer ("
					+ e.getMessage() + ")");
		}
	...
	public String getFolder(String key, String defaultFolder,
			boolean autoCreate, boolean mandatory) throws AppException
	{
			...
			if (autoCreate)
			{
				...
				catch (Exception e)
				{
					throw new AppException(e.getMessage(),
							"ManageableThread.loadDirectory", key);
				}
			}
		}
		else if (mandatory)
	...
	public String getFolder(String key, boolean autoCreate, boolean mandatory)
			throws AppException
	{
